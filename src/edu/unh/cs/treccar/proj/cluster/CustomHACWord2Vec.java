...
public class CustomHACWord2Vec {
	...
	public CustomHACWord2Vec(Properties p, String pID, ArrayList<String> paraIDs, ArrayList<String> sectionIDs, HashMap<String, double[]> vecs){
		this.prop = p;
		this.pageID = pID;
